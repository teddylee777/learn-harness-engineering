...
<div class="card-grid">
  <a href="/zh/lectures/lecture-01-why-capable-agents-still-fail/" class="card">
    <h3>讲义</h3>
    <p>理解为什么强大的模型依然会失败，掌握构建有效 Harness 的理论基础。</p>
  </a>
  <a href="/zh/projects/" class="card">
    <h3>项目</h3>
    <p>动手实践，从零开始搭建一个可靠的 Agent 工作环境。</p>
  </a>
  <a href="/zh/resources/" class="card">
    <h3>资料库</h3>
...
<ul class="index-list">
  <li><a href="/zh/lectures/lecture-01-why-capable-agents-still-fail/">L01. 模型能力强，不等于执行可靠</a>：从理论开始。</li>
  <li><a href="/zh/projects/project-01-baseline-vs-minimal-harness/">P01. 提示词 vs 规则驱动</a>：完成你的第一个对比实战任务。</li>
  <li><a href="/zh/resources/templates/">中文模板</a>：获取最小 Harness 模板包（AGENTS.md、feature_list.json 等），直接用于你的项目。</li>
</ul>
